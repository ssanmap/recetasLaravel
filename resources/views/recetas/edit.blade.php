...
@endsection
@section('content')
<h2 class="text-center mb-5">Editando tu Receta : {{ $receta->titulo }}</h2>
...
<div class="col-md-8 bg-light">
    <form action="{{ route('recetas.update', ['receta' => $receta->id]) }}" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-group">
           ...
           >
                ...
                <option value="{{$categoria->id}}"
                    {{ $receta->categoria_id == $categoria->id ? 'selected' : ''}}> {{$categoria->nombre}}</option>
                @endforeach
            </select>
        ...
        <div class="form-group mt-3">
            ...
            <div class="mt-4">
                <p>Imagen Actual:</p>
                <img src="/storage/{{ $receta->imagen}}" style="width:230px;" alt="">
            </div>
